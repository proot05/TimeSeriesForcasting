...
# ~40 Hz sampled data
freq = 2
loader = MembraneDataLoader(date="4-9-25", frequency=freq, number=3, repo_dir=repo_dir)
mem_time, mem_data = loader.load_data()
bad_data_buffer = 150
mem_time_test = mem_time[bad_data_buffer:train_size]
mem_data_test = mem_data[bad_data_buffer:train_size]
